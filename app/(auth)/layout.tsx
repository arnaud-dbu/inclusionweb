	...
	return (
		<div className="flex h-screen items-center justify-center">
			<div className={`flex items-center gap-16 px-4`}>
				<Card
					className={`absolute left-1/2 top-1/2 z-10 flex w-[90%] max-w-[35rem] -translate-x-1/2 -translate-y-1/2 flex-col gap-1 px-12 py-8 md:gap-2 md:px-16 md:py-12 lg:gap-3`}>
					{children}
				</Card>
				<Image
					className={`invisible w-screen max-w-[40rem] opacity-50 md:visible md:max-w-[80rem] lg:max-w-[85rem] `}
